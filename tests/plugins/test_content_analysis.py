...
class TestRouteToAppropriateAgent:
    ...
    def test_route_transcript_content(self, sample_app_context_transcript, sample_available_agents):
        """Test routing transcript content."""
        result = route_to_appropriate_agent(sample_app_context_transcript, sample_available_agents)
        assert "Successfully routed transcript to transcripts_agent" in result
    
    def test_route_blog_post_content(self, sample_app_context_blog, sample_available_agents):
        """Test routing blog post content."""
        result = route_to_appropriate_agent(sample_app_context_blog, sample_available_agents)
        assert "Successfully routed blog_post to blog_agent" in result
    
    def test_route_release_notes_content(self, sample_app_context_release, sample_available_agents):
        """Test routing release notes content."""
        result = route_to_appropriate_agent(sample_app_context_release, sample_available_agents)
    ...
    def test_route_content_no_agent_available(self, sample_app_context_transcript):
        ...
        result = route_to_appropriate_agent(sample_app_context_transcript, available_agents)
...
class TestAssessEngagementPotential:
    ...
    def test_assess_non_engaging_content(self):
        ...
        text = "The data indicates that the system functions according to specifications."
