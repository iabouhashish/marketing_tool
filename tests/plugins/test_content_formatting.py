...
class TestApplyFormattingRules:
    ...
    def test_apply_formatting_rules_with_content_context(self, sample_blog_post, sample_style_guide):
...
class TestGeneratePublicationReadyContent:
    ...
    def test_generate_publication_ready_content_with_content_context(self, sample_blog_post):
...
class TestIntegration:
    ...
    def test_full_content_formatting_workflow(self, sample_blog_post, sample_style_guide):
