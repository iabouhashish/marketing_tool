...
class TestGenerateBriefOutline:
    ...
    def test_generate_brief_outline_with_seo_keywords(self, sample_article_data):
        ...
        assert len(data['seo_strategy']['secondary_keywords']) >= 0  # May be 0 if less than 6 keywords
    ...
    def test_generate_brief_outline_extracts_key_messages(self, sample_article_data):
        ...
        sample_article_data['content'] = "This is important information. The main point is clear. Key benefits include efficiency."
...
class TestDefineTargetAudience:
    ...
    def test_define_target_audience_business_content(self, sample_content_context):
        ...
        sample_content_context.content = "This strategy requires management decision making and leadership planning."
    ...
    def test_define_target_audience_beginner_content(self, sample_content_context):
        ...
        sample_content_context.content = "This is an introduction to the basics and getting started guide."
...
class TestSetContentObjectives:
    ...
    def test_set_content_objectives_review_content(self, sample_content_context):
        ...
        assert isinstance(result, dict)
        primary_objectives = result['primary_objectives']
        assert any('Provide comprehensive analysis' in obj for obj in primary_objectives)
...
class TestCreateContentStrategy:
    ...
    def test_create_content_strategy_with_all_inputs(self, sample_content_context):
        ...
        result = create_content_strategy(sample_content_context, target_audience, objectives)
    ...
    def test_create_content_strategy_tutorial_content(self, sample_content_context):
        ...
        sample_content_context.content = "This tutorial guide will teach you the basics."
    ...
    def test_create_content_strategy_review_content(self, sample_content_context):
        ...
        # Add review content
        sample_content_context.content = "This review compares different options and analysis."
    ...
    def test_create_content_strategy_news_content(self, sample_content_context):
        ...
        # Add news content
        sample_content_context.content = "This is important news and update information."
...
class TestAnalyzeCompetitorContent:
    ...
    def test_analyze_competitor_content_with_content_context(self, sample_content_context):
    ...
    def test_analyze_competitor_content_with_urls(self, sample_content_context):
        ...
        assert any('Analyze competitor content themes' in insight for insight in competitor_insights)
    ...
    def test_analyze_competitor_content_suggests_opportunities(self, sample_content_context):
...
class TestGenerateContentCalendarSuggestions:
    ...
    def test_generate_content_calendar_suggestions_with_content_context(self, sample_content_context):
    ...
    def test_generate_content_calendar_suggestions_tutorial_content(self, sample_content_context):
    ...
    def test_generate_content_calendar_suggestions_review_content(self, sample_content_context):
    ...
    def test_generate_content_calendar_suggestions_weekly_schedule(self, sample_content_context):
    ...
    def test_generate_content_calendar_suggestions_seasonal_content(self, sample_content_context):
...
class TestIntegration:
    ...
    def test_full_marketing_brief_processing_workflow(self, sample_content_context):
        ...
        strategy_result = create_content_strategy(sample_content_context, audience_result, objectives_result)
        ...
        calendar_result = generate_content_calendar_suggestions(sample_content_context, strategy_result)
...
class TestEdgeCases:
    ...
    def test_create_content_strategy_minimal_inputs(self, sample_content_context):
        ...
        result = create_content_strategy(sample_content_context, minimal_audience, minimal_objectives)
    ...
    def test_generate_content_calendar_suggestions_minimal_strategy(self, sample_content_context):
        """Test generating calendar suggestions with minimal strategy."""
        minimal_strategy = {}
        
        result = generate_content_calendar_suggestions(sample_content_context, minimal_strategy)
